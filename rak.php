                    ...
                    <div class="panel-heading">
                    	<div class="row">
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-4 col-xs-6" align="right">
                            	<button type="button" name="add" id="add_button" data-toggle="modal" data-target="#rakModal" class="btn btn-success btn-xs">Add</button>
                        	</div>
							-->
                        </div>
                   	...
                   	<div class="panel-body">
                   		<div class="row"><div class="col-sm-12 table-responsive">
                   			<table id="rak_tampil" class="table table-bordered table-striped">
                   				<thead>
									<tr>
										<th>No</th>
										<th>Nama Rak</th>
...
$(document).ready(function(){
	...
	var userdataTable = $('#rak_tampil').DataTable({
